                    ...
                    <cc1:HlpWebGridView ID="gridConsultaClientes" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Código Alter.">
                                <ItemTemplate>
                                    <asp:HyperLink ID="objHyperLink" runat="server" Text='<%# Eval("CD_ALTER", "{0:D7}") %>'
                                        NavigateUrl='<%# Eval("CD_ALTER", "Pedido.aspx?CD_ALTER={0}") %>'
                            ...
                            <asp:BoundField DataField="CD_FONENOR" HeaderText="Fone">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
