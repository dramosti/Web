...
public partial class PesquisaPendenciaCliente : System.Web.UI.Page
{
    ...
    protected void btnPesquisar_Click(object sender, EventArgs e)
    {
        ...
        {
            bFiltroValido = true;
            sWhere = ("(d.NM_GUERRA IS NOT NULL)");
        }
        else if (rdbCodigo.Checked)
        {
            ...
            if (bFiltroValido)
            {
                ...
                string sCdClifor = objUsuario.oTabelas.hlpDbFuncoes.qrySeekValue("CLIFOR", "CD_CLIFOR", "CD_ALTER = '" + txtCodigo.GetValor().ToString().PadLeft(7, '0') + "'");
