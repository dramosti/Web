...
public partial class CadastroCliente : System.Web.UI.Page, ITelaCadastroWeb
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string sST_LIBERADO_TOTALMENTE = objUsuario.oTabelas.hlpDbFuncoes.qrySeekValue("CLIFOR", "coalesce(ST_LIBERADO_TOTALMENTE,'A')", "CD_ALTER = '" + Request["CD_ALTER"].ToString() + "'");
            if (sST_LIBERADO_TOTALMENTE.Equals("N") || sST_LIBERADO_TOTALMENTE.Equals("A"))
            {
                Response.Redirect("~/PesquisarClientes.aspx?bLiberado=false");               
            }
