            ...
            <cc1:HlpWebMultiView ID="MultViewConsultaClientes" runat="server" ActiveViewIndex="0">
                ...
                <div align="center">
                    <cc1:HlpWebGridView ID="gridConsultaClientes" runat="server" AutoGenerateColumns="False"
                        ...
                        RowHeaderColumn="CD_CLIFOR" DataKeyNames="CD_CLIFOR"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Cliente">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Eval("CD_CLIFOR", "{0:D7}") %>'
                                        NavigateUrl='<%# Eval("CD_CLIFOR", "CadastroCliente.aspx?CD_CLIFOR={0}") %>'
                                        designer:wfdid="w6"></asp:HyperLink></ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Nome de Guerra">
                                <EditItemTemplate>
                                    <asp:TextBox runat="server" Text='<%# Bind("NM_GUERRA") %>' ID="TextBox3"></asp:TextBox></EditItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# Bind("NM_GUERRA") %>' ID="Label3"></asp:Label></ItemTemplate>
                            </asp:TemplateField>
