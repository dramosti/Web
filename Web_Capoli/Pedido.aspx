        ...
        <asp:MultiView ID="MultiViewItensPed" runat="server" ActiveViewIndex="0">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="cbxCD_PRAZO" runat="server" AutoPostBack="True" CssClass="textBox"
                                DataTextField="DS_PRAZO" DataValueField="CD_PRAZO" Enabled="false" Width="185px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <br />
                            <asp:Button ID="btnIncluiItens" runat="server" CssClass="button" OnClick="btnIncluiItens_Click" Height="26px"
                                Text="Incluir Itens" Width="180px" />
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnVerificarPendencias" runat="server" OnClick="btnVerificarPendencias_Click" Height="26px"
                                Text="Pendência Financeira" CssClass="button" Width="180px" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
            ...
            <asp:View ID="ViewItens" runat="server">
                <table width="100%">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <asp:GridView ID="GridViewNovo" runat="server" AllowSorting="True" AlternatingRowStyle-CssClass="alt"
                                ...
                                OnSelectedIndexChanged="GridViewNovo_SelectedIndexChanged" PagerStyle-CssClass="pgr"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Vl. Unitário">
                                        <ItemTemplate>
                                            &nbsp;<asp:TextBox ID="txtValorUnitario" runat="server" BackColor="Info" BorderColor="#E0E0E0"
                                                OnTextChanged="txtValorUnitario_TextChanged" AutoPostBack="true" Font-Names="Segoe UI"
                                                Font-Size="13px" MaxLength="10" Text='<%# Bind("VL_PROD") %>' Width="100px"></asp:TextBox>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtValorUnitario" runat="server" BackColor="White" AutoPostBack="true"
                                                OnTextChanged="txtValorUnitario_TextChanged" BorderColor="#E0E0E0" Font-Names="Segoe UI"
                                                Font-Size="13px" MaxLength="3" Text='<%# Bind("VL_PROD") %>' Width="100px"></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Width="110px" Wrap="False" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Pacote">
                                        <ItemTemplate>
                                            &nbsp;<asp:TextBox ID="txtPacote" runat="server" BackColor="Info" BorderColor="#E0E0E0"
                                                Font-Names="Segoe UI" Font-Size="13px" MaxLength="4" Text='<%# Bind("PACOTE") %>'
                                                Width="50px"></asp:TextBox>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtPacote" runat="server" AutoPostBack="true" BackColor="White"
                                                BorderColor="#E0E0E0" Font-Names="Segoe UI" Font-Size="13px" MaxLength="3" Text='<%# Bind("PACOTE") %>'
                                                Width="33px"></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Width="60px" Wrap="False" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="SUBTOTAL" HeaderText="Vl. Total" HtmlEncode="False" Visible="False">
                                    ...
                                    <asp:BoundField DataField="QT_PROD" DataFormatString="{0:0.0000}" HeaderText="Qtde">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Width="80px" />
                                    </asp:BoundField>
                                </Columns>
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnAvancar" runat="server" OnClick="btnAvancar_Click" Text="Finalizar Pedido"
                                CssClass="button" Width="135px" />
                        </td>
                    </tr>
                </table>
            </asp:View>
