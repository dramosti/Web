...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div align="center" style="color: Black">
        <cc1:HlpWebPanel ID="HlpWebPanel2" runat="server" Width="100%">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 70%">
                                <cc1:HlpWebTextBox ID="txtCdRg" runat="server" Campo="CD_RG" Tabela="CLIFOR" Width="155px"
                                    MaxLength="12" CssClass="textBox"></cc1:HlpWebTextBox>
            ...
            </cc1:HlpWebMultiView><table width="100%" style="font-size: 8pt; font-family: Segoe UI">
                <tr>
                    <td align="right" class="label">
                        Contato
                    </td>
                    <td style="text-align: left; width: 70%; height: 16px;">
                        <cc1:HlpWebTextBox ID="txtDsContato" runat="server" Campo="DS_CONTATO" MaxLength="20"
