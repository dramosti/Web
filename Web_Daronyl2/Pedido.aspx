        ...
        <asp:MultiView ID="MultiViewItensPed" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="ViewItens" runat="server">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="cbxConranca1" runat="server" AutoPostBack="True" CssClass="textBox"
                                AppendDataBoundItems="true" DataTextField="DS_TPCOBR" DataValueField="CD_TPCOBR"
                                Enabled="True" Width="185px">
                                <asp:ListItem>Selecione um item</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        <td align="right" class="style3">Forma de Pagamento 
                        </td>
                        <td align="left">
                            <asp:DropDownList ID="cbxFormaPgto" runat="server" AutoPostBack="True" CssClass="textBox"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtTotalPedidoSemDesc" runat="server" Width="180" CssClass="textBox" MaxLength="4"
                        ...
                        <td align="center" colspan="2">
                            <asp:GridView ID="GridViewNovo" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField Visible="false" DataField="VL_DESCONTO" HeaderText="Desconto" HeaderStyle-HorizontalAlign="Left"
                                    ...
                                    <asp:TemplateField HeaderText="Vl. Unitário">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtValorUnit" runat="server" BackColor="Info" BorderColor="#E0E0E0" Font-Names="Segoe UI"
                                                Font-Size="13px" MaxLength="9" Text='<%# Bind("VL_PROD") %>' />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtValorUnit" runat="server" BackColor="White" BorderColor="#E0E0E0"
                                                Font-Names="Segoe UI" Font-Size="13px" MaxLength="9" Text='<%# Bind("VL_PROD") %>' />
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Width="60px" Wrap="False" />
                                    </asp:TemplateField>
