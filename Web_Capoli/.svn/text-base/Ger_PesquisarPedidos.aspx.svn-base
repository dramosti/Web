<%@ Page Title="" Language="C#" MasterPageFile="~/Ger_Site.master" AutoEventWireup="true" CodeFile="Ger_PesquisarPedidos.aspx.cs" Inherits="Ger_PesquisarPedidos" %>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 100px; text-align: right">
                    <cc1:HlpWebLabel ID="HlpWebLabel5" runat="server" CssClass="label">Nome de guerra</cc1:HlpWebLabel>
                </td>
