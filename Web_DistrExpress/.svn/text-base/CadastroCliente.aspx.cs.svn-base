...
public partial class CadastroCliente : System.Web.UI.Page, ITelaCadastroWeb
{
    ...
    private bool ValoresValidosCliente()
    {
        ...
        if (bPessoaJuridica)
        {
            ...
            {
                if (!ValidarInscEstadual(txtCdInsest.Text))
                {
