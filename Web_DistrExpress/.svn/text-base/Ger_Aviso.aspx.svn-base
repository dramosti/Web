<%@ Page Title="Cadastro de Avisos" Language="C#" MasterPageFile="~/Ger_Site.master"
    AutoEventWireup="true" CodeFile="Ger_Aviso.aspx.cs" Inherits="Ger_Aviso" %>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox runat="server" CssClass="textBox" ID="txtAviso" Width="400px" TextMode="MultiLine"
                    MaxLength="2" Height="100px"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtDataFinal"
